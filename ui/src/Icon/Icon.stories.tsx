...
const meta = {
  ...
  parameters: {
    viu: {
      ...
      overview:
        "Glifo de 16px con stroke en currentColor. Set del sistema: Plus, Check, Chevron, Close, Arrow, Search, Info, Alert, Visibility, VisibilityOff.",
      ...
      anatomy: ["SVG 16×16, stroke currentColor 1.5.", "Glyph — uno de los 10 del set."],
